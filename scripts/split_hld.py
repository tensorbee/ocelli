#!/usr/bin/env python3
"""Historical bootstrap converter for the numbered files under docs/hld/.

No gate or workflow calls this script. The tracked Markdown files are
authoritative.
...
HEADER = """<!-- Originally converted by scripts/split_hld.py from Ocelli-HLD.docx.
...
**Source**: bootstrap import from `Ocelli-HLD.docx`, {sections}. This tracked Markdown is authoritative.
