...
fourth pass, and it said the skip lived in S02's profile when it lived in S01's,
which made this register the last place in the repository where a removed
exception still read as live.
