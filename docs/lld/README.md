...
| [dicom-ingest.md](dicom-ingest.md) | Part 10 parsing, DICOMweb source responses, lossless metadata providers, transfer-syntax dispatch and refusal boundaries | F-016, F-017, F-021 |
...
| [codecs.md](codecs.md) | Explicit decoder registration, capability, and exact Transfer Syntax UID dispatch | F-023 |
| [corpus.md](corpus.md) | Golden corpus layout, generation and verification | F-009, F-013, F-014, F-016, F-X006, F-X007, F-X012, F-X013 |
| [build-targets.md](build-targets.md) | The wasm pipeline, the size budget, the cross-target proof and the isolation invariant | F-002, F-004, F-005, F-007, F-008, F-016, F-021, F-022, F-023, F-X008 |
...
| [typescript-packaging.md](typescript-packaging.md) | What the npm packages publish, and what proves it | F-003, F-004, F-005, F-X017 |
...
| [benchmarks.md](benchmarks.md) | The benchmark harness of HLD section 26, its subject registry, the host class and the `bench` gate | F-006, F-023, F-X014 |
