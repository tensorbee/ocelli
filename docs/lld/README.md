...
| [build-targets.md](build-targets.md) | The wasm pipeline, the size budget, the cross-target proof and the isolation invariant | F-002, F-005, F-007, F-008 |
| [gpu-ownership.md](gpu-ownership.md) | One device, one queue, one owner. The section 31 contract | F-005, F-008 |
