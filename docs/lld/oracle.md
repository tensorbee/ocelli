...
`corpus/quirks.json` names `bin/ocelli.sh gate oracle` as the production
...
checker-owned edits in the CI corpus-tooling job and requires their fixed
boundaries to go red for the recorded reasons. The oracle and corpus gates
